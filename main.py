...
async def шар(ctx, *, question):
    responses = ["А ты как считаешь?",
                 ...
                 "Может быть",
                 "┻━┻ ︵ヽ(`Д´)ﾉ︵ ┻━┻",
                 "Я бы ответил, но ответ столько очевиден, что я не буду подсказывать",
                 "Мне так не кажется",
                 "Вы, как назойливые мухи!",
                 "Ебанутый ты задаёшь в ебанутом мире ебанутые вопросы ебанутому мне, чтобы получить ебанутый ответ?",
                 "Ебать мой лысый хуй, ты что, совсем, что ли?",
                 "Мне кажется, ты хочешь получить пизды, причём в плохом смысле",
